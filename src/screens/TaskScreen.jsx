...
import { updateReduxTask, setReduxProfiles, addReduxTask, } from "../Redux/userSlice";
...
const TaskScreen = ({ navigation, route }) => {
  ...
  const handleExtendTime = async() => {
    ...
    const currentEndTime = new Date(task.endTime);
    ...
    try {
      const userDocRef = firebase.firestore().collection("users").doc("rl0yP34KttOEJ6f5LeFZIKn87jn2");
  ...
  const handleTransferProfile = () => {
    ...
    const availableProfiles = user.profiles.filter((profile) => profile.id !== task.assignedTo);
        ...
        >
          <View style={styles.modalContainer}>
            ...
            <View style={styles.menuContainer}>
              <TouchableOpacity style={styles.menuItem} onPress={handleExtendTime}>
                <Text style={styles.menuText}>Add more time</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.menuItem} onPress={handleTransferProfile}>
                <Text style={styles.menuText}>העבר פרופיל</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.menuItem} onPress={handleEditTask}>
                <Text style={styles.menuText}>ערוך מטלה</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.menuItem} onPress={handleDeleteTask}>
                <Text style={styles.menuText}>מחק מטלה</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.menuItem} onPress={handleApproveTask}>
                <Text style={styles.menuText}>אשר מטלה</Text>
              </TouchableOpacity>
            </View>
          </View>
        </Modal>
