...
export const UserFamilyComponent = ({
  Familyname,
  setFamilyName,
  userName,
  setUserName,
...
export const PasswordsComponent = ({
  ...
  <View style={[styles.passwordsContainer]}>
    {password && !(password === confirmPassword) ? (
      <Text style={styles.passwordRedMessage}>Passwords not matching</Text>
    ) : (
...
export const GenderNameBDay = ({
  ...
  return (
    <View style={styles.passkeyBday}>
      <View style={styles.genNamBDay}>
        <View style={styles.dropdownContainer}>
          <Dropdown
            ...
            renderLeftIcon={() => {
              const selectedGender = gender_data.find(
                (genderItem) => genderItem.value === gender
              );
      ...
      <TouchableOpacity
        ...
        >
          <FontAwesome name={"birthday-cake"} size={calculateFontSize(12)}>
            <Text style={styles.dateText}>Birthday</Text>
          </FontAwesome>
          <Text style={styles.date}>{formattedDate}</Text>
        </TouchableOpacity>
        <KeyboardAvoidingView style={styles.passkeyContainer}>
          <TextInput
            style={styles.inputComponent}
            placeholder="Passkey"
            inputMode="numeric"
...
export const SelectAvatar = ({ onPressFunc, style }) => {
  return (
    <View style={[styles.selectAvatar, style]}>
